{
  ...
  "object": "db_object",
  "status": "success",
  "datafield1": "ALTER SERVER AUDIT SPECIFICATION [ForChangeSpec] ADD (BACKUP_RESTORE_GROUP), ADD (BROKER_LOGIN_GROUP)",
  ...
  "object.query": "ALTER SERVER AUDIT SPECIFICATION [ForChangeSpec] ADD (BACKUP_RESTORE_GROUP), ADD (BROKER_LOGIN_GROUP)",
